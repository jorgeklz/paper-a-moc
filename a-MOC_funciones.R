...
CoexpressionIndicator<- function(i, clusters, par_matriz_expresion) { 
  ...
  if (length(lista_genes_cluster_actual)>1) {
    ...
    exp_cluster_actual<-par_matriz_expresion[lista_genes_cluster_actual,]
...
calculaDistanciasResultados<-function(par_matriz_exp, par_nombre_distancia){
  ...
  #par_nombre_distancia=pearson
  #par_nombre_distancia=euclidean
  #par_nombre_distancia=spearman
  #par_nombre_distancia=kendall  
...
repararSingletons<-function(par_poblacion_reparar, par_distancia_exp, par_distancia_bio, num_k, alfa) {
  ...
  #poblacion solo con medodides
 #par_poblacion_reparar<-populationR
  #par_distancia_exp<-distancia_exp
  #par_distancia_bio<-distancia_bio
